...
const DEFAULT_SETTINGS = {
    ...
    pubnodes_custom: ['127.0.0.1:21698'],
...
log.info(`Starting ElectronicWallet ${WALLETSHELL_VERSION}`);
...
function createWindow() {
    ...
    let bgColor = darkmode ? '#000000' : '#beac04';

    const winOpts = {
        title: WIN_TITLE,
        icon: path.join(__dirname, 'src/assets/electronicwallet_icon.png'),
        frame: true,
