...
class ElectronicWalletApi {
    constructor(args) {
        args = args || {};
        if (!(this instanceof ElectronicWalletApi)) return new ElectronicWalletApi(args);
    ...
    sendTransaction(params) {
        return new Promise((resolve, reject) => {
            ...
            if (parseFloat(params.fee) < 0.1) return reject(new Error('Minimum fee is 0.1 ZTC'));
            //[{address: "Zexxxx...", amount: 100}];
            var req_params = {
...
module.exports = ElectronicWalletApi;