...
var ElectronicWalletAddressBook = function (path, name, pass) {
    if (!(this instanceof ElectronicWalletAddressBook)) return new ElectronicWalletAddressBook(pass, name, path);
    this.path = path;
...
ElectronicWalletAddressBook.prototype.setParams = function (path, pass) {
    if (path) this.path = path;
    if (pass) this.pass = pass;
    return true;
};

ElectronicWalletAddressBook.prototype.create = function (ignoreExists) {
...
ElectronicWalletAddressBook.prototype.initFile = function () {
    return new Promise((resolve, reject) => {
        try {
...
ElectronicWalletAddressBook.prototype.load = function () {
    return new Promise((resolve, reject) => {
...
ElectronicWalletAddressBook.prototype.save = function (addressBookData) {
    return new Promise((resolve, reject) => {
        let gcm = new GCM(this.pass, this.cipherConfig);
...
module.exports = ElectronicWalletAddressBook;